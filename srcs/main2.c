...
//gere l'execution des builtins qui doivent se faire dans le process parent
...
//verifie si on a un builtin unique qui doit s'executer dans le parent
//doit etre une cmd sans pipe
//doit etre un builtin special (cd, unset, exit ou export), les autres peuvent s'exec dans un process enfant
